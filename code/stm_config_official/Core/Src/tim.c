...
//NOTE: htim1.Init.Period and htim15.Init.Period should be
//set to PWM_CTR_PRD. This setting will be destroyed when
...
void MX_TIM15_Init(void)
{
  ...
  htim15.Init.Period = PWM_CTR_PRD;
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* tim_encoderHandle)
{
  ...
  /* USER CODE END TIM8_MspDeInit 0 */
    ...
    PC7     ------> TIM8_CH2
    */
    HAL_GPIO_DeInit(GPIOC, ENC2B_Pin|ENC2A_Pin);
